...
onMounted(() => {
  ...
  isDarkMode.value =  classList.contains('dark');
...
<template>
  <div class="flex flex-col max-w-xl mx-auto rounded-lg backdrop-blur border border-[var(--aw-color-primary-50)] dark:border-[var(--aw-color-accent-50)] shadow p-4 sm:p-6 lg:p-8 w-full">
    
    <form v-if="formVisible" @submit="submit">
      <!-- Form Inputs -->
      <div class="mb-[15px]">
        <label for="name">Name <span class="text-[var(--aw-color-accent)]">*</span></label>
        <input 
          type="text" 
          id="name" 
          name="name" 
          ...
          class="py-3 px-4 block w-full text-md rounded-lg border border-[var(--aw-color-primary-50)] text-black" 
        />
      </div>

      <div class="mb-[15px]">
        <label for="email">Email <span class="text-[var(--aw-color-accent)]">*</span></label>
        <input 
          type="email" 
          id="email" 
          name="email" 
      ...
      <div class="mb-[15px]">
        <label for="message">Message <span class="text-[var(--aw-color-accent)]">*</span></label>
        <textarea 
          id="message" 
          name="message" 
          ...
          class="py-3 px-4 block w-full text-md rounded-lg min-h-40 border border-[var(--aw-color-primary-50)] text-black"
        />
        <p class="text-sm text-right text-[var(--aw-color-text-muted)]">{{ formData.message.length }} / {{ messageMaxLength }}</p>
      </div>

      <div class="mt-3 flex">
        <div class="ml-3 mb-4">
          <p class="text-sm text-[var(--aw-color-text-muted)]">
            By submitting this contact form, you acknowledge and agree to the collection of your information per our <a class="text-[var(--aw-color-primary-50)] dark:text-[var(--aw-color-primary)]" href="/privacy">privacy policy</a>.
          </p>
        </div>
      </div>
      ...
      <button 
        ...
        class="btn-primary border-[var(--aw-color-primary-50)] rounded-lg hover:bg-[--aw-color-secondary] dark:hover:bg-[var(--aw-color-secondary)] dark:border-[var(--aw-color-primary)] dark:focus:bg-[var(--aw-color-secondary)]" 
